...
| `fixedLabel`      | `fixed-label`      | IF true, the label will always be visible (the size should be standard)                                                                                                                                                                                                                       | `boolean`               | `true`       |
...
| `placeholder`     | `placeholder`      | Select placeholder                                                                                                                                                                                                                                                                            | `string`                | `''`         |
| `size`            | `size`             | The size of select, if the size is set to short, the label won't be shown together with the value                                                                                                                                                                                             | `"short" \| "standard"` | `'standard'` |
